...
func workflowPage(t *testing.T) idpui.WorkflowPage {
	...
	return idpui.WorkflowPage{
		...
		Form:          idpui.WorkflowForm{ActionURL: "https://idp.example/authorize", InteractionField: idpui.InteractionFieldName, Interaction: strings.Repeat("a", 32), CSRFField: idpui.CSRFFieldName, CSRFToken: strings.Repeat("b", 32), ActionField: idpui.ActionFieldName},
