...
func (*module) TypeScriptModule() *spec.Module {
	return &spec.Module{
		...
		RawDTS: []string{
			...
			`export interface InvocationContext<I = unknown, C = Record<string, unknown>> { readonly input: Readonly<I>; readonly cap: C; readonly present: PresentationBuilders; readonly secret: SecretContext; readonly commit: CommitBuilders; }`,
