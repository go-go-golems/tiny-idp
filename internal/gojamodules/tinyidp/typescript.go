...
func (*module) TypeScriptModule() *spec.Module {
	return &spec.Module{
		...
		RawDTS: []string{
			...
			`export type ProviderKind = "identity" | "invitation" | "authorization" | "claims"; export type ProviderState = "virtual" | "durable"; export type ReplayProtection = "none" | "expiry" | "one_time"; export type RevocationMode = "none" | "key_rollover" | "durable";`,
