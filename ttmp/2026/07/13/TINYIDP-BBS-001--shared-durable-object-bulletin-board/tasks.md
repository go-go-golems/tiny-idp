...
- [x] Phase 3.1: Convert the placeholder frontend to pnpm, Vite, React, TypeScript, Redux Toolkit, RTK Query, and Bootstrap. <!-- t:98is -->
- [x] Phase 3.2: Implement session bootstrap, CSRF-aware API base query, board queries, post/reply mutations, deletion, and logout. <!-- t:3b4q -->
- [x] Phase 3.3: Implement accessible post composition, board statistics, thread rendering, reply composition, empty/loading/error states, and ownership controls. <!-- t:l160 -->
