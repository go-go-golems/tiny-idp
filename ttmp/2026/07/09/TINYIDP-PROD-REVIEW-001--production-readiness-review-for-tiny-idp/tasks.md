...
- [x] Map the repository architecture, entrypoints, trust boundaries, persistence, and protocol flows.
- [x] Review all production runtime code and tests with line-anchored evidence.
- [x] Capture authoritative external sources under `sources/` using Defuddle.
- [x] Build reusable audit and smoke-test tools under `scripts/`.
