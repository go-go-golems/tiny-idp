...
Added the primary model-checking system architecture and implementation plan, derived all ten task phases from evidence gaps and exit artifacts, and repositioned the original long guide as the theory/research companion.
