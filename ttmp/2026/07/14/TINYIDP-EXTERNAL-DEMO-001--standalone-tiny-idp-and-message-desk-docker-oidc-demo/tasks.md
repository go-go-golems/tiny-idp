...
- [x] Phase 1: Define two-container topology, trust boundaries, issuer and redirect contract <!-- t:cvqz -->
- [x] Phase 2: Add standalone tiny-idp Docker image, persistent state, seeded demo accounts, and client bootstrap <!-- t:i82l -->
- [x] Phase 3: Refactor Message Desk into external-issuer relying-party mode without embedded provider imports <!-- t:ovm9 -->
...
- [x] Phase 6.1: Add two-origin OIDC integration tests <!-- t:zktj -->
- [x] Phase 6.2: Add browser smoke for login, scopes, chooser, local logout, and global logout <!-- t:p7x6 -->
- [x] Phase 6.3: Add failure, secret-leak, and persistence isolation checks <!-- t:hj1t -->
