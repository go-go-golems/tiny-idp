...
- [x] Add property, fuzz, race, replay, and normalized-trace tests at the phase that introduces each codec, transition, store, worker lifecycle, or effect boundary <!-- t:lf90 -->
- [x] Keep production scripting and `tinyidp/verify` runtime/module/capability profiles separate; do not make verification tooling a prerequisite for request-path execution <!-- t:lf91 -->
